...
public class OgDoctorRegistration extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
      public void dropdownHospital(){
       
        ArrayList<String> hDropdown = new ArrayList<>();
        for(int i = 0; i < HospitalDirectory.hospDir.size(); i++){
            hDropdown.add(HospitalDirectory.hospDir.get(i).hospName);
        }
       
        String[] hSDropdown = hDropdown.toArray(new String[hDropdown.size()]);
        DefaultComboBoxModel<String> yearsSDropdownModel = new DefaultComboBoxModel<>(hSDropdown);
        ch.setModel(yearsSDropdownModel);
    ...
    private void initComponents() {
        ...
        doctorHomeBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        doctorLogoutBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        doctorRegisterBtn.setBackground(java.awt.SystemColor.inactiveCaption);
        doctorRegisterBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        doctorDeleteBtn.setBackground(java.awt.SystemColor.inactiveCaption);
        doctorDeleteBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        jPanel3.setBackground(new java.awt.Color(184, 216, 246));
        ...
        docTable.setBackground(new java.awt.Color(184, 216, 246));
    ...
    private void doctorRegisterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doctorRegisterBtnActionPerformed
        ...
        doc.residence.setHouseNo((Integer.parseInt(houseCombo.getSelectedItem().toString())));
...
//        pt1.person.setAge(Integer.parseInt(patientAge.getText()));
        ...
        selectedDoc.residence.houseNo= (Integer.parseInt(houseCombo.getSelectedItem().toString()));
