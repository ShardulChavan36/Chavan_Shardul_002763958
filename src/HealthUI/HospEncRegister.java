 ...
 * @author chava
 */
public class HospEncRegister extends javax.swing.JFrame {

    /**
     * Creates new form HospEncRegister
     */
    ...
    int randomEncId;
    public HospEncRegister(EncounterHistory encHis,PatientDirectory patientDir,DoctorDirectory docDir,VitalSignsHistory vitalDir) {
        initComponents();
        this.docDir = docDir;
        this.encHis = encHis;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Encounter Hospital Registration");
...
//            java.util.logging.Logger.getLogger(HospEncRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new HospEncRegister().setVisible(true);
//            }
//        });
//    }
