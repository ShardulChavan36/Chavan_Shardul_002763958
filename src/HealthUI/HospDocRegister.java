 ...
 * @author chava
 */
public class HospDocRegister extends javax.swing.JFrame {

    /**
     * Creates new form HospDocRegister
     */
    Doctor doc = new Doctor();
    DoctorDirectory docDir;
    Community houseDir;
    public HospDocRegister(DoctorDirectory docDir) {
        initComponents();
        this.docDir=docDir;
        if(houseDir == null){
...
//            java.util.logging.Logger.getLogger(HospDocRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new HospDocRegister().setVisible(true);
//            }
//        });
    }
